        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ url('/reserva') }}">Reservas</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                    <div class="row">
                        <div class="col-6">
                            <p><a href="{{url('/acerca')}}">Acerca de Online Coffee</a></p>
                            <p><a href="{{url('/terminos')}}">Términos y condiciones</a></p>
                            <p><a href="{{url('/politica')}}">Política de Privacidad</a></p>
                            <p><a href="{{url('/preguntas')}}">Preguntas frecuentes</a></p>
                            <p><a href="{{url('/reglamento')}}">Reglamento</a></p>
                        </div>
                        <div class="col-6">
                            <p><a href="{{url('/contacto')}}">Contáctanos</a></p>
                            <p><a href="{{url('/soporte')}}">Soporte</a></p>
                            <p><a href="#"></a></p>
